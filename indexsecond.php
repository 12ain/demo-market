...
$sql = "SELECT * FROM business_goods WHERE Gsecond = '二手'  ORDER BY Gid DESC LIMIT $start_from, $num_rec_per_page";
$sqlt = "SELECT * FROM business_goods WHERE Gsecond = '二手'  ORDER BY Gid";
