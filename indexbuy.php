...
$sql = "SELECT * FROM business_goods WHERE Gsecond = '求购'  ORDER BY Gid DESC LIMIT $start_from, $num_rec_per_page";
$sqlt = "SELECT * FROM business_goods WHERE Gsecond = '求购'  ORDER BY Gid";
...
$rowst = [];
while($rowt = $mysql_result->fetch_array(MYSQLI_ASSOC)){
    $rowst[] = $rowt;
}
