                ...
                <li><div class="navbar-collapse collapse">
                    <form class="navbar-form">
                        <div class="form-group input-group">
                            <input type="text" class="form-control" id="key-movie" placeholder="输入商品名称">
            ...
            <div class="inputmain">
                ...
                <div class="inputmain-content">
                    <?php
                        ...
                        //session_start();
                        if (isset($_SESSION['userName'])) {
                            echo "<form action='savebuy.php' method='post'role='form' enctype='multipart/form-data'>
                        <div class='form-group'>
                            <span class='inputmain-content-item'>商品名称:</span><input type='text' class='form-control' name='sname'>
                        </div>
                        <div class='form-group'>
                            <span class='inputmain-content-item'>预期价格:</span><input type='text' class='form-control' name='sprice'>
                        </div>
                        <div class='form-group'>
                ...
                <input type='submit' class='btn btn-success'>
                            ...
                            echo '<br><b>你还未登录哦！5秒钟之后将为您跳转到登录页面<b><br>';
